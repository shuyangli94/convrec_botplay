...
class System(pl.LightningModule):
    ...
    def __init__(
        ...
        print(
            ">> Creating EMPTY BPRUserKP model with kwargs:\n{}".format(
        ...
        # Load weights
        self.pt_model_dir = self.config.pretrained

        self.pt_ckpt = get_last_mod_ckpt(self.pt_model_dir, allow_last=True)
        self.model.load_state_dict(load_checkpoint(self.pt_ckpt), strict=True)
        print(">> Loaded pretrained weights from {}".format(self.pt_ckpt))
